...
export default async function Dashboard(props: {
  ...
  const getWidth = (val: number) =>
    totalComms === 0 ? 0 : Math.max((val / totalComms) * 100, 2);
    ...
    <div className="flex-col gap-8">
      ...
      >
        ...
        >
          <div
            style={{
              background:
                "linear-gradient(to top, rgba(124,58,237,0.06), transparent)",
              position: "absolute",
              bottom: 0,
              left: 0,
              right: 0,
          ...
          >
            ...
            >
              {getTrendPct([10, 15, 20, 18, 25, 22, 30])} vs last week
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            >
              {getTrendPct([50, 45, 60, 55, 70, 68, 85])} vs last week
            </div>
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            >
              {getTrendPct([2, 2, 3, 3, 5, 5, 8])} vs last week
            </div>
          </div>
        </div>
      </div>
      ...
      >
        <div
          ...
          style={{ borderTop: "2px solid rgba(124,58,237,0.4)" }}
        >
          ...
          {totalComms === 0 ? (
            ...
            >
              ...
              <p style={{ fontSize: "12px", color: "var(--text-muted)" }}>
                Launch a campaign to see delivery data
              </p>
            </div>
          ) : (
            <div
            ...
            >
              ...
              >
                {funnelMap.SENT >= 0 && (
                  <React.Fragment>
                    <Link
                      href={filterStatus === "SENT" ? "/" : "/?status=SENT"}
                      scroll={false}
                      style={{
                        flex: funnelMap.SENT || 1,
                        height: "100%",
                        display: "block",
                      }}
                    >
                      <div
                        style={{
                          ...
                          borderRadius: "2px",
                          opacity:
                            filterStatus && filterStatus !== "SENT" ? 0.3 : 1,
                    ...
                    >
                      <div
                        style={{
                          ...
                          borderRadius: "2px",
                          opacity:
                            filterStatus && filterStatus !== "DELIVERED"
                              ? 0.3
                              : 1,
                          transition: "opacity 0.2s ease",
                        }}
                ...
                {funnelMap.OPENED >= 0 && (
                  <React.Fragment>
                    <Link
                      href={filterStatus === "OPENED" ? "/" : "/?status=OPENED"}
                      scroll={false}
                      style={{
                        flex: funnelMap.OPENED || 1,
                        height: "100%",
                        display: "block",
                      }}
                    >
                      <div
                        style={{
                          ...
                          clipPath: "polygon(0 20%, 100% 30%, 100% 70%, 0 80%)",
                          borderRadius: "2px",
                          opacity:
                            filterStatus && filterStatus !== "OPENED" ? 0.3 : 1,
                          transition: "opacity 0.2s ease",
                        }}
                        title="Opened"
                      />
                ...
                {funnelMap.CLICKED >= 0 && (
                  <React.Fragment>
                    <Link
                      href={
                        filterStatus === "CLICKED" ? "/" : "/?status=CLICKED"
                      }
                      scroll={false}
                      style={{
                        flex: funnelMap.CLICKED || 1,
                        height: "100%",
                        display: "block",
                      }}
                    >
                      <div
                        style={{
                          ...
                          clipPath: "polygon(0 30%, 100% 40%, 100% 60%, 0 70%)",
                          borderRadius: "2px",
                          opacity:
                            filterStatus && filterStatus !== "CLICKED"
                              ? 0.3
                              : 1,
                          transition: "opacity 0.2s ease",
                        }}
                ...
                {funnelMap.FAILED >= 0 && (
                  <React.Fragment>
                    <Link
                      href={filterStatus === "FAILED" ? "/" : "/?status=FAILED"}
                      scroll={false}
                      style={{
                        flex: funnelMap.FAILED || 1,
                        height: "100%",
                        display: "block",
                      }}
                    >
                      <div
                        style={{
                          ...
                          clipPath: "polygon(0 40%, 100% 50%, 100% 50%, 0 60%)",
                          borderRadius: "2px",
                          opacity:
                            filterStatus && filterStatus !== "FAILED" ? 0.3 : 1,
                          transition: "opacity 0.2s ease",
                        }}
                        title="Failed"
                      />
