        ...
        >
          <div>
            <div className="flex items-center justify-between mb-4">
              ...
              >
                <Filter size={16} /> Segment Filters
              </h2>
            ...
            <form onSubmit={handleGenerate} className="flex-col gap-4">
              <div style={{ position: "relative" }}>
                ...
                >
                  <Sparkles size={12} />{" "}
                  {loading ? "Analyzing..." : "Preview Audience"}
                </button>
              </div>
            </form>
          </div>
          ...
          >
            ...
            <div className="flex-col gap-2">
              {segments.map((seg) => (
                <div
                  key={seg.id}
                  className="card-inner flex justify-between items-center"
                  style={{ padding: "12px" }}
                >
                  <div>
                    <div
                    ...
                    >
                      {JSON.parse(seg.criteria || "{}").prompt ||
                        "Custom audience"}
                    </div>
                  </div>
            ...
            {!results ? (
              ...
              >
                ...
                <p style={{ color: "var(--text-muted)" }}>
                  Generate a preview to see customers here
                </p>
              </div>
            ) : (
              <table
                ...
                <tbody>
                  {results.customers?.map((customer: any, i: number) => {
                    const initials = customer.name
                      ...
                      .substring(0, 2);
                    const spend =
                      customer.totalSpends || Math.floor(Math.random() * 5000);
                    ...
                    return (
                      <tr
                        ...
                        style={{
                          ...
                          animation: `pageEnter 300ms ease-out ${i * 50}ms forwards`,
                          opacity: 0,
                        }}
                      >
